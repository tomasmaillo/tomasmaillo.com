...
<div className="w-full h-auto bg-card rounded-lg flex flex-col justify-center items-center p-2 my-6 ">
  <div className="z-50">
    ...
    <div className="relative w-full h-96 flex justify-center items-center lg:group-hover:scale-[2] transition-all duration-300">
      <video src="/my-video.mp4" width={159} height={100} autoPlay muted loop playsInline className="rounded-lg" />
      <Image src="/phone.png" alt="Project Share Website" width={300} height={100} className="absolute rounded scale-[1.2]" draggable={false}/>
    </div>
  </div>
