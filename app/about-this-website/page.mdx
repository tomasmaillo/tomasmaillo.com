...
The 2024 version is built with Next.js, TailwindCSS, and hosted on Vercel. I optimised for the smallest size and the fastest possible load time, something new to my portfolio series.
...
An issue with going for a clean and minimalist design is it's hard to make it stand out. Both my dad and <Avatar person={Person.RussellCook} /> told me this. For non-technical users or people not focused on the details, the 2024 page could come across as a WordPress template.
