...
After the hackathon, <Avatar url="https://unavatar.io/github/StanFlint" name="Stan Flint" link="https://stanflint.dev/" /> and I decided to continue working on the project. 
